...
import com.example.wahdahpharmacy.ui.customer.activities.customerAuth.CustomerLogin;
...
public class PharmacistRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.pharmacist_register_toolbar);
    ...
    private void toolbarSetter(ActionBar toolbar) {
        ...
        toolbar.setTitle(getString(R.string.pharmacist_register));
    }
}