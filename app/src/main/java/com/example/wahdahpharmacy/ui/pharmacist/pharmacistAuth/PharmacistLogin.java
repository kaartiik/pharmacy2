...
import com.example.wahdahpharmacy.ui.customer.activities.customerAuth.CustomerRegister;
import com.example.wahdahpharmacy.ui.pharmacist.PharmacistHome;
...
public class PharmacistLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.pharmacist_login_toolbar);
        ...
        registerTextView.setOnClickListener(v -> startActivity(new Intent(PharmacistLogin.this, CustomerRegister.class)));
    ...
    private void toolbarSetter(ActionBar toolbar) {
        ...
        toolbar.setTitle(getString(R.string.pharmacist_login));
    }
}
